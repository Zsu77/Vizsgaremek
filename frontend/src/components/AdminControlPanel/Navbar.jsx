...
let navigation = [
  ...
  { name: 'Create Schedule', href: '/admin/schedule', current: false },
  { name: 'Schedules', href: '/admin/schedule-history', current: false },
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                {user.admin && (
                  <Link to="/">
                    <button
                      type="button"
                      className="flex items-center px-1 py-1 font-medium text-gray-100 bg-gray-800 rounded hover:bg-red-700"
                    >
                      User View
                ...
                <Menu as="div" className="relative ml-3">
                  ...
                  >
                    <Menu.Items className="absolute z-10 w-40 py-1 mt-2 font-medium origin-top-right bg-white rounded-md shadow-lg right-4 ring-1 ring-black ring-opacity-5 focus:outline-none">
                      <Menu.Item>
                        {({ active }) => (
                          <Link
                            to="#"
