        ...
        <td>
          <div className="flex items-center justify-between">
            <div className="pl-3">
              ...
              <p className="mt-0 mb-2 text-base text-gray-600 md:text-lg">
                {date}
              </p>
            </div>
        ...
        <td className="w-1/12">
          <div>
            {status && (
              ...
              >
                <p className="text-base leading-3 text-green-700">
                  Approved
                </p>
              </div>
            )}
            ...
            {currentDate <= requestDate && !status && approvedBy == "" && (
              ...
              >
                <p className="text-base leading-3 text-yellow-700">
                  Pending
                </p>
              </div>
            )}
            ...
            {currentDate > requestDate && !status && (
              ...
              >
                <p className="text-base leading-3 text-red-700">
                  Not approved
                </p>
              </div>
            )}
